...
export default function AdminLoginPage() {
  ...
  // Clear error whenever inputs change
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div style={{ marginBottom: "18px" }}>
              ...
              <input
                ...
                style={{
                  width: "100%",
                  background: "#080D10",
                  border: `1px solid ${error ? "rgba(255,60,172,0.4)" : "rgba(0,229,255,0.15)"}`,
                  borderRadius: "7px",
                  padding: "11px 14px",
                  color: "#E8F4F8",
                  fontFamily: '"Syne", sans-serif',
            ...
            <button
              ...
              style={{
                ...
                background: loading
                  ? "rgba(0,229,255,0.05)"
                  : "linear-gradient(135deg, rgba(0,229,255,0.15), rgba(123,47,255,0.15))",
